...
class SignUpScreen extends Component {
  ...
  fullNameHandler = (fullName) => this.setState({ fullName }, () => this.validate());
  
  passwordHandler = (password) => this.setState({ password }, () => this.validate());

  confirmPasswordHandler = (confirm_password) => this.setState({ confirm_password }, () => this.confirmPassword());
  ...
  googleSignUp = async () => {
    ...
    this.props.onGoogleSignUp({ token, fullName: user.user.name, email: user.user.email });
  };
